...
function resolveSignalReactionLevel(): { agentReactionGuidance?: string } {
  return {};
}

function resolveTelegramInlineButtonsScope(): "off" {
  return "off";
}

function resolveTelegramReactionLevel(): { agentReactionGuidance?: string } {
  return {};
}
