...
vi.mock("../channels/plugins/telegram-update-offset-store.js", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../channels/plugins/telegram-update-offset-store.js")>();
  return {
    ...actual,
