import { d as visibleWidth, u as stripAnsi$1 } from "./subsystem-C5Ov5Tl6.js";
import { $c as formatToolDetail, $l as formatRawAssistantErrorForUi, $m as VERSION, $r as formatRelativeTimestamp, Cf as assertExplicitGatewayAuthModeWhenBothConfigured, Eh as formatThinkingLevels, Gc as listChatCommandsForConfig, Ih as resolveResponseUsageMode, Oh as listThinkingLevelLabels, Ph as normalizeUsageDisplay, Sa as GatewayClient, Wc as listChatCommands, bf as resolveConfiguredSecretInputString, da as ensureExplicitGatewayAuth, ei as formatTimeAgo, el as resolveToolDisplay, fd as GATEWAY_CLIENT_CAPS, hd as GATEWAY_CLIENT_NAMES, la as buildGatewayConnectionDetails, md as GATEWAY_CLIENT_MODES, nm as loadConfig, pa as resolveExplicitGatewayAuth } from "./reply-BJBzAldK.js";
import { c as resolveAgentIdByWorkspacePath, f as resolveDefaultAgentId } from "./agent-scope-mSwAEzsR.js";
import { T as parseAgentSessionKey, c as normalizeMainKey, r as buildAgentMainSessionKey, s as normalizeAgentId } from "./session-key-COcqKA5t.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BlmM3Rpg.js";
import { s as formatTokenCount, y as stripLeadingInboundMetadata } from "./session-cost-usage-CPJEuaoV.js";
