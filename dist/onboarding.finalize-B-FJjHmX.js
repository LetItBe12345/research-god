import { p as restoreTerminalState } from "./subsystem-C1ZwgyXv.js";
import "./paths-dQ_clcF4.js";
import "./boolean-BHdNsbzF.js";
import "./auth-profiles-DZ4zIQH4.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-lHks6gb9.js";
...
import { f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint, y as waitForGatewayReachable } from "./onboard-helpers-4CUqO3j0.js";
...
import { t as runTui } from "./tui-Bbt2bl9L.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-F1RJTY3g.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-E3t5DS1A.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-E3t5DS1A.js");
