import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-C1ZwgyXv.js";
import { u as resolveGatewayPort } from "./paths-dQ_clcF4.js";
import { Bp as resolveDefaultSecretProviderAlias, Dp as readConfigFileSnapshot, jp as writeConfigFile } from "./auth-profiles-DZ4zIQH4.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { h as resolveUserPath } from "./utils-D0Yqqtk-.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-BrzD-dBG.js";
import { t as assertSupportedRuntime } from "./runtime-guard-J6FFyZo2.js";
import "./daemon-runtime-DnPtziIn.js";
import { a as ensureWorkspaceAndSessions, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, y as waitForGatewayReachable } from "./onboard-helpers-4CUqO3j0.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-BP8P5KzB.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CH1zk80A.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-B9uQ0VXf.js").then((n) => n.r);
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-hEPUS2XY.js").then((n) => n.t);
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BWhGr5HF.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CI4lxNPA.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BIaLfF-x.js").then((n) => n.i);
