import { B as resolvePreferredOpenClawTmpDir, O as isRich, f as defaultRuntime, k as theme } from "./subsystem-C1ZwgyXv.js";
import "./paths-dQ_clcF4.js";
import "./boolean-BHdNsbzF.js";
import { Ea as buildNodeShellCommand, Ks as applyPathPrepend, Ma as randomIdempotencyKey, Qs as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, _a as parsePairingList, ac as normalizeExecAsk, bi as formatTimeAgo, cc as resolveExecApprovalsFromFile, ec as loadExecApprovals, fp as normalizeHostname, ga as parseNodeList, oc as normalizeExecSecurity, q as formatHelpExamples, rc as minSecurity, tc as maxAsk, up as fetchWithSsrFGuard, va as parsePreparedSystemRunPayload, wp as loadConfig } from "./auth-profiles-DZ4zIQH4.js";
import { r as resolveCliName } from "./command-format-CO3N-oGG.js";
import { f as resolveDefaultAgentId, i as resolveAgentConfig } from "./agent-scope-lHks6gb9.js";
import { _ as shortenHomePath, g as shortenHomeInString } from "./utils-D0Yqqtk-.js";
...
import { a as resolveNodeId, i as resolveNode, n as callGatewayCli, o as unauthorizedHintForMessage, r as nodesCallOpts, s as formatPermissions, t as buildNodeInvokeParams } from "./rpc-Bi8A_hHg.js";
import { t as parseTimeoutMs } from "./parse-timeout-Epy9yUeO.js";
...
function registerNodesCanvasCommands(nodes) {
	...
	nodesCallOpts(a2ui.command("push").description("Push A2UI JSONL to the canvas").option("--jsonl <path>", "Path to JSONL payload").option("--text <text>", "Render a quick A2UI text payload").requiredOption("--node <idOrNameOrIp>", "Node id, name, or IP").option("--invoke-timeout <ms>", "Node invoke timeout in ms").action(async (opts) => {
		await runNodesCommand("canvas a2ui push", async () => {
			...
			const jsonl = hasText ? buildA2UITextJsonl(String(opts.text ?? "")) : await fs$1.readFile(String(opts.jsonl), "utf8");
