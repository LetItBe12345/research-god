import { c as resolveStateDir, d as resolveHomeRelativePath, f as resolveRequiredHomeDir, l as expandHomePrefix, r as resolveConfigPath, u as resolveEffectiveHomeDir } from "./paths-9tafYejD.js";
...
async function ensureAgentWorkspace(params) {
	...
	if (!state.onboardingCompletedAt) markState({ onboardingCompletedAt: nowIso() });
...
//#endregion
export { redactSensitiveText as $, colorize as $n, normalizeStringEntries as $t, supportsMemoryMultimodalEmbeddings as A, defaultRuntime as An, filterBootstrapFilesForSession as At, resolveWindowsSpawnProgram as B, isRecord as Bn, logInfo as Bt, isFileMissingError as C, resolveThreadParentSessionKey as Cn, DEFAULT_BOOTSTRAP_FILENAME as Ct, getMemoryMultimodalExtensions as D, createSubsystemLogger as Dn, DEFAULT_TOOLS_FILENAME as Dt, classifyMemoryMultimodalPath as E, toAgentModelListLike as En, DEFAULT_SOUL_FILENAME as Et, resolveSessionTranscriptPath as F, clampInt as Fn, runExec as Ft, openFileWithinRoot as G, shortenHomePath as Gn, openBoundaryFileSync as Gt, appendFileWithinRoot as H, resolveConfigDir as Hn, markOpenClawExecEnv as Ht, resolveSessionTranscriptPathInDir as I, clampNumber as In, resolveWindowsCommandShim as It, writeFileWithinRoot as J, truncateUtf16Safe as Jn, isPathInside as Jt, readFileWithinRoot as K, sleep as Kn, resolvePathViaExistingAncestorSync as Kt, resolveSessionTranscriptsDirForAgent as L, ensureDir$1 as Ln, spawnWithFallback as Lt, resolveDefaultSessionStorePath as M, registerActiveProgressLine as Mn, resolveOpenClawPackageRoot as Mt, resolveSessionFilePath as N, unregisterActiveProgressLine as Nn, resolveOpenClawPackageRootSync as Nt, isMemoryMultimodalEnabled as O, sanitizeForLog as On, DEFAULT_USER_FILENAME as Ot, resolveSessionFilePathOptions as P, CONFIG_DIR as Pn, runCommandWithTimeout as Pt, getDefaultRedactPatterns as Q, shouldLogVerbose as Qn, normalizeHyphenSlug as Qt, resolveStorePath as R, escapeRegExp as Rn, logDebug as Rt, splitTextToUtf8ByteLimit as S, parseAgentSessionKey as Sn, DEFAULT_AGENT_WORKSPACE_DIR as St, buildCaseInsensitiveExtensionGlob as T, resolveAgentModelPrimaryValue as Tn, DEFAULT_IDENTITY_FILENAME as Tt, copyFileWithinRoot as U, resolveUserPath as Un, canUseBoundaryFileOpen as Ut, SafeOpenError as V, normalizeE164 as Vn, logWarn as Vt, createRootScopedReadFile as W, shortenHomeInString as Wn, openBoundaryFile as Wt, assertNoPathAliasEscape as X, logVerbose as Xn, normalizeSkillFilter as Xt, PATH_ALIAS_POLICIES as Y, isPlainObject as Yn, normalizeWindowsPathForComparison as Yt, runTasksWithConcurrency as Z, setVerbose as Zn, normalizeAtHashSlug as Zt, remapChunkLines as _, deriveSessionChatType as _n, resolveDefaultAgentId as _t, listSessionFilesForAgent as a, isValidAgentId as an, readLoggingConfig as ar, kindFromMime as at, estimateStructuredEmbeddingInputBytes as b, isCronSessionKey as bn, resolveSessionAgentIds as bt, buildMultimodalChunkForIndexing as c, resolveAgentIdFromSessionKey as cn, isBunRuntime as cr, mediaKindFromMime as ct, ensureDir as d, scopedHeartbeatWakeOptions as dn, resolveAgentConfig as dt, DEFAULT_AGENT_ID as en, isRich as er, redactToolDetail as et, hashText as f, toAgentRequestSessionKey as fn, resolveAgentDir as ft, parseEmbedding as g, isBlockedObjectKey as gn, resolveAgentWorkspaceDir as gt, normalizeExtraMemoryPaths as h, normalizeOptionalAccountId as hn, resolveAgentSkillsFilter as ht, buildSessionEntry as i, classifySessionKeyShape as in, normalizeLogLevel as ir, isAudioFileName as it, resolveAgentsDirFromSessionStorePath as j, clearActiveProgressLine as jn, loadWorkspaceBootstrapFiles as jt, normalizeMemoryMultimodalSettings as k, stripAnsi as kn, ensureAgentWorkspace as kt, chunkMarkdown as l, resolveThreadSessionKeys as ln, isNodeRuntime as lr, hasConfiguredModelFallbacks as lt, listMemoryFiles as m, normalizeAccountId as mn, resolveAgentModelFallbacksOverride as mt, isQueryStopWordToken as n, buildAgentMainSessionKey as nn, getChildLogger as nr, extensionForMime as nt, sessionPathForFile as o, normalizeAgentId as on, resolvePreferredOpenClawTmpDir as or, normalizeMimeType as ot, isMemoryPath as p, DEFAULT_ACCOUNT_ID as pn, resolveAgentEffectiveModelPrimary as pt, writeFileFromPathWithinRoot as q, sliceUtf16Safe as qn, isNotFoundPathError as qt, requireNodeSqlite as r, buildAgentPeerSessionKey as rn, getResolvedLoggerSettings as rr, getFileExtension as rt, buildFileEntry as s, normalizeMainKey as sn, consumeRootOptionToken as sr, MAX_IMAGE_BYTES as st, extractKeywords as t, DEFAULT_MAIN_KEY as tn, theme as tr, detectMime as tt, cosineSimilarity as u, sanitizeAgentId as un, listAgentIds as ut, runWithConcurrency as v, getSubagentDepth as vn, resolveRunModelFallbacksOverride as vt, statRegularFile as w, resolveAgentModelFallbackValues as wn, DEFAULT_HEARTBEAT_FILENAME as wt, estimateUtf8Bytes as x, isSubagentSessionKey as xn, DEFAULT_AGENTS_FILENAME as xt, hasNonTextEmbeddingParts as y, isAcpSessionKey as yn, resolveSessionAgentId as yt, materializeWindowsSpawnProgram as z, formatTerminalLink as zn, logError as zt };
