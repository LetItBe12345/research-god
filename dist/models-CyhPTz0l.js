import { D as colorize, O as isRich$1, k as theme } from "./subsystem-C1ZwgyXv.js";
import "./paths-dQ_clcF4.js";
import "./boolean-BHdNsbzF.js";
import { $ as resolveCommandSecretRefsViaGateway, A as normalizeProviderId, Ap as setRuntimeConfigSnapshot, B as resolvePluginProviders, Bt as formatRemainingShort, C as findNormalizedProviderValue, Cm as hasUsableCustomProviderApiKey, Cp as createConfigIO, D as modelKey, Dm as resolveUsableCustomProviderApiKey, Eh as resolveAuthProfileDisplayLabel, Em as resolveEnvApiKey, F as resolveDefaultModelForAgent, Hd as resolveSecretRefString, Jn as runEmbeddedPiAgent, K as withProgressTotals, L as resolveModelRefFromString, Lt as maskApiKey, Om as getShellEnvAppliedKeys, Op as readConfigFileSnapshotForWrite, P as resolveConfiguredModelRef, Rt as DEFAULT_OAUTH_WARN_MS, S as buildModelAliasIndex, Sm as getCustomProviderApiKey, Tm as resolveAwsSdkEnvVarName, X as getModelsCommandSecretTargetIds, ar as describeFailoverError, b as resolveAuthStorePathForDisplay, ci as formatUsageWindowSummary, d as listProfilesForProvider, f as setAuthProfileOrder, fh as DEFAULT_MODEL, fr as discoverAuthStorage, g as loadAuthProfileStoreForRuntime, gp as loadModelCatalog, i as resolveProfileUnusableUntilForDisplay, j as parseModelRef, km as shouldEnableShellEnvFallback, li as resolveUsageProviderId, lr as resolveModelWithRegistry, m as ensureAuthProfileStore, n as resolveAuthProfileOrder, nh as isNonSecretApiKeyMarker, oi as loadProviderUsageSummary, p as upsertAuthProfile, ph as DEFAULT_PROVIDER, pr as discoverModels, r as clearAuthProfileCooldown, t as resolveAuthProfileEligibility, vp as shouldSuppressBuiltInModel, wm as resolveApiKeyForProvider, wp as loadConfig, yp as resolveOpenClawAgentDir, zt as buildAuthHealthSummary } from "./auth-profiles-DZ4zIQH4.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-lHks6gb9.js";
...
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-BrzD-dBG.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CmL1n6G7.js";
...
import { n as renderTable, t as getTerminalTableWidth } from "./table-Bza8Ia2x.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-Ckv3SH6X.js";
import { n as redactSecrets } from "./format-1LLawgRu.js";
...
import { t as loginOpenAICodexOAuth } from "./openai-codex-oauth-BoDqUlFi.js";
import "./note-QL6AfaP7.js";
import { t as createClackPrompter } from "./clack-prompter-BsorKzB7.js";
import { n as validateAnthropicSetupToken } from "./auth-token-Cjub2Rkc.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-CBTpPbPu.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-DZ4zIQH4.js").then((n) => n._p);
