...
import { r as isMainModule } from "./entry.js";
import { Ha as GatewayClient, Nu as GATEWAY_CLIENT_MODES, Pa as resolveGatewayCredentialsWithSecretInputs, Pu as GATEWAY_CLIENT_NAMES, _h as listThinkingLevels, ep as isKnownCoreToolId, ka as buildGatewayConnectionDetails, wp as loadConfig } from "./auth-profiles-DZ4zIQH4.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-C-xoIovu.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-DRIU5Paa.js";
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-CUqWnuWU.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-CMvz-16P.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-GHW-TuRy.js");
