import { f as defaultRuntime, t as createSubsystemLogger } from "./subsystem-C1ZwgyXv.js";
import { $ as resolveCommandSecretRefsViaGateway, A as normalizeProviderId, An as clearSessionAuthProfileOverride, Ap as setRuntimeConfigSnapshot, Au as resolveMessageChannel, Ch as normalizeVerboseLevel, Cu as INTERNAL_MESSAGE_CHANNEL, D as modelKey, Du as isInternalMessageChannel, Ei as normalizeReplyPayload, El as resolveSessionTranscriptFile, Eu as isGatewayMessageChannel, F as resolveDefaultModelForAgent, Ft as setCliSessionId, Gr as clearAgentRunContext, Hr as formatAgentInternalEventsForPrompt, It as runCliAgent, J as getAgentRuntimeCommandSecretTargetIds, Jn as runEmbeddedPiAgent, Kr as emitAgentEvent, Nl as updateSessionStore, Nt as runWithModelFallback, O as normalizeModelRef, Oi as buildOutboundSessionContext, On as getSkillsSnapshotVersion, Op as readConfigFileSnapshotForWrite, P as resolveConfiguredModelRef, Pt as getCliSessionId, Qr as resolveAcpDispatchPolicyError, Qt as getRemoteSkillEligibility, Si as resolveContextTokensForModel, St as resolveSessionDeliveryTarget, T as isCliProvider, Th as supportsXHighThinking, Ur as normalizeSpawnedRunMetadata, Vl as normalizeAccountId, Vr as resolveAgentTimeoutMs, Vt as applyVerboseOverride, Wn as resolveSendPolicy, Xr as resolveAcpSessionCwd, Yn as prepareSessionManagerForRun, Yr as registerAgentRunContext, Zr as resolveAcpAgentPolicyError, _u as normalizeChannelId, ai as applyModelOverrideToSessionEntry, al as isSilentReplyText, au as resolveSessionResetType, cu as setSessionRuntimeModel, dt as normalizeOutboundPayloadsForJson, du as resolveExplicitAgentSessionKey, fh as DEFAULT_MODEL, gp as loadModelCatalog, gt as resolveMessageChannelSelection, hh as formatXHighModelHint, hu as getChannelPlugin, il as isSilentReplyPrefixText, ir as FailoverError, iu as resolveSessionResetPolicy, jl as loadSessionStore, kl as emitSessionTranscriptUpdate, ku as normalizeMessageChannel, lt as formatOutboundPayloadLog, m as ensureAuthProfileStore, mh as formatThinkingLevels, ni as AGENT_LANE_SUBAGENT, nr as resolveBootstrapWarningSignaturesSeen, nu as evaluateSessionFreshness, ol as getAcpSessionManager, ou as mergeSessionEntry, ph as DEFAULT_PROVIDER, ru as resolveChannelResetConfig, sl as toAcpRuntimeError, st as deliverOutboundPayloads, ti as AGENT_LANE_NESTED, tu as resolveSessionKey, ut as normalizeOutboundPayloads, wp as loadConfig, wu as isDeliverableMessageChannel, x as buildAllowedModelSet, xh as normalizeThinkLevel, xt as resolveOutboundTarget, yc as clearBootstrapSnapshotOnSessionRollover, z as resolveThinkingDefault } from "./auth-profiles-DZ4zIQH4.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { D as ensureAgentWorkspace, a as resolveAgentDir, d as resolveAgentWorkspaceDir, h as resolveSessionAgentId, p as resolveEffectiveModelFallbacks, r as listAgentIds, u as resolveAgentSkillsFilter } from "./agent-scope-lHks6gb9.js";
import { c as normalizeMainKey, l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-9lbhEIb9.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-NeRNNbEl.js";
import { l as resolveStorePath } from "./paths-CmL1n6G7.js";
import { d as deriveSessionTotalTokens, f as hasNonzeroUsage } from "./session-cost-usage-Zj7Y3VA9.js";
import { n as createDefaultDeps, t as createOutboundSendDeps } from "./outbound-send-deps-DhlZGSiY.js";
