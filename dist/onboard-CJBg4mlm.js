...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-C5Ov5Tl6.js";
import { g as resolveUserPath } from "./utils-J_jJJlhx.js";
import { am as readConfigFileSnapshot, lm as writeConfigFile, vm as resolveDefaultSecretProviderAlias } from "./reply-BJBzAldK.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-BlmM3Rpg.js";
...
import "./daemon-runtime-3pRKLH22.js";
import { a as ensureWorkspaceAndSessions, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, y as waitForGatewayReachable } from "./onboard-helpers-BEzP-_2l.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-D5EkX1fD.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CuSrWJqb.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-ChJv9xB3.js").then((n) => n.r);
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BT1LRRt9.js").then((n) => n.t);
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DLg0O2Zo.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-4hlggDWr.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BYvOcIvf.js").then((n) => n.i);
