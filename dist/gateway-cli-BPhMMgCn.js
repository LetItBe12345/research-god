import { A as getChildLogger, C as setVerbose, D as colorize, M as getResolvedLoggerSettings, O as isRich, a as setConsoleSubsystemFilter, c as sanitizeForLog, f as defaultRuntime, j as getLogger, k as theme, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger, x as logVerbose } from "./subsystem-C1ZwgyXv.js";
...
import { $a as validateAgentsUpdateParams, $f as PROFILE_OPTIONS, $i as evaluateGatewayAuthSurfaceStates, $l as normalizeInputProvenance, $n as waitForEmbeddedPiRunEnd, $o as validateSecretsResolveResult, $p as isSupportedLocalAvatarExtension, $r as readLatestAssistantReply, $s as ensureExecApprovals, $t as primeRemoteSkillsCache, Aa as callGateway, Ac as setTtsEnabled, Af as pickPrimaryLanIPv4, Al as archiveRemovedSessionTranscripts, Am as getGlobalHookRunner, Ao as validateExecApprovalsNodeGetParams, Ar as isExternalHookSession, As as buildDeviceAuthPayload, At as loadCronStore, Ba as authorizeOperatorScopesForMethod, Bc as waitForActiveTasks, Bf as disableTailscaleServe, Bi as normalizeOptionalSessionKey, Bl as normalizeSessionDeliveryFields, Bn as extractImageContentFromSource, Bo as validateNodePairApproveParams, Bu as isPidAlive, Ca as matchSystemRunApprovalBinding, Cc as isTtsEnabled, Cf as isLocalishHost, Ch as normalizeVerboseLevel, Ci as computeBackoff, Co as validateDevicePairRejectParams, Cp as createConfigIO, Cr as resolveSubagentToolPolicy, Cs as validateWizardStatusParams, Ct as resolveOutboundChannelPlugin, Cu as INTERNAL_MESSAGE_CHANNEL, Da as buildExecApprovalPendingReplyPayload, Dc as resolveTtsConfig, Df as isTrustedProxyAddress, Di as extractShortModelName, Dl as extractDeliveryInfo, Do as validateExecApprovalRequestParams, Dp as readConfigFileSnapshot, Dr as buildSafeExternalPrompt, Ds as ConnectErrorDetailCodes, Dt as buildChannelUiCatalog, Ec as resolveTtsAutoMode, Eo as validateDeviceTokenRotateParams, Ep as readBestEffortConfig, Er as createOpenClawTools, Es as parseSessionLabel, Eu as isGatewayMessageChannel, F as resolveDefaultModelForAgent, Fa as ADMIN_SCOPE$3, Fd as ensureGatewayStartupAuth, Fi as normalizeCronStaggerMs, Fo as validateNodeDescribeParams, Fs as loadGatewayTlsRuntime$1, Ft as setCliSessionId, Fu as hasGatewayClientCap, G as withProgress, Ga as validateAgentParams, Gi as parseAbsoluteTimeMs, Gl as cleanupArchivedSessionTranscripts, Gn as isAbortRequestText, Go as validateNodePendingAckParams, Gr as clearAgentRunContext, Gt as emitGatewayRestart, H as createPluginRuntime, Hf as enableTailscaleServe, Hi as normalizePayloadToSystemText, Hl as archiveFileOnDisk, Hn as resolveInputFileLimits, Ho as validateNodePairRejectParams, Hs as enqueueSystemEvent, Ht as parseVerboseOverride, Hu as readJsonFile, I as resolveHooksGmailModel, Ia as APPROVALS_SCOPE$1, Ic as getTotalQueueSize, Id as mergeGatewayAuthConfig, If as pickPrimaryTailnetIPv4, Ii as resolveCronStaggerMs, In as DEFAULT_INPUT_IMAGE_MAX_BYTES, Io as validateNodeEventParams, Ir as listDescendantRunsForRequester, Is as deriveDeviceIdFromPublicKey, It as runCliAgent, Iu as normalizeGatewayClientMode, Ja as validateAgentsDeleteParams, Ji as clearSecretsRuntimeSnapshot, Jl as resolveSessionTranscriptCandidates, Jn as runEmbeddedPiAgent, Jo as validateNodeRenameParams, Jp as AVATAR_MAX_BYTES, Jr as onAgentEvent, Js as requestHeartbeatNow, Jt as scheduleGatewaySigusr1Restart, Ka as validateAgentWaitParams, Kc as isDiagnosticsEnabled, Ki as normalizeLegacyDeliveryInput, Kl as readSessionMessages, Kn as stopSubagentsForRequester, Ko as validateNodePendingDrainParams, Kr as emitAgentEvent, Kt as isGatewaySigusr1RestartExternallyAllowed, La as PAIRING_SCOPE$1, Lc as markGatewayDraining, Ld as mergeGatewayTailscaleConfig, Lf as pickPrimaryTailnetIPv6, Li as resolveDefaultCronStaggerMs, Ln as DEFAULT_INPUT_IMAGE_MIMES, Lo as validateNodeInvokeParams, Ls as loadOrCreateDeviceIdentity, M as resolveAllowedModelRef, Mc as textToSpeech, Mf as resolveGatewayBindHost, Mi as normalizeHttpWebhookUrl, Mn as buildChannelAccountBindings, Mo as validateExecApprovalsSetParams, Mp as validateConfigObjectWithPlugins, Ms as normalizeDeviceMetadataForAuth, Mt as saveCronStore, Mu as GATEWAY_CLIENT_IDS, Nc as enqueueCommandInLane, Nf as resolveGatewayListenHosts, Ni as normalizeCronJobCreate, Nl as updateSessionStore, No as validateLogsTailParams, Np as OpenClawSchema, Nt as runWithModelFallback, Nu as GATEWAY_CLIENT_MODES, Oa as ToolInputError, Oc as resolveTtsPrefsPath, Of as isValidIPv4, Oi as buildOutboundSessionContext, Ol as parseSessionThreadInfo, On as getSkillsSnapshotVersion, Oo as validateExecApprovalResolveParams, Op as readConfigFileSnapshotForWrite, Or as detectSuspiciousPatterns, Os as resolveAuthConnectErrorDetailCode, Ou as isWebchatClient, P as resolveConfiguredModelRef, Pc as getActiveTaskCount, Pf as resolveRequestClientIp, Pi as normalizeCronJobPatch, Po as validateModelsListParams, Pr as initSubagentRegistry, Ps as normalizeDeviceAuthScopes, Pt as getCliSessionId, Pu as GATEWAY_CLIENT_NAMES, Qa as validateAgentsListParams, Qc as getMachineDisplayName, Qf as resolveToolProfilePolicy, Qi as GATEWAY_AUTH_SURFACE_PATHS, Ql as stripInlineDirectiveTagsFromMessageForDisplay, Qn as waitForActiveEmbeddedRuns, Qo as validateSecretsResolveParams, Qp as isPathWithinRoot, Qs as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, Qt as getRemoteSkillEligibility, R as resolveSubagentConfiguredModelSelection, Rc as resetAllLanes, Rd as resolveConfiguredSecretInputString, Rf as safeEqualSecret, Rl as deliveryContextFromSession, Rn as DEFAULT_INPUT_TIMEOUT_MS, Ro as validateNodeInvokeResultParams, Rs as normalizeDevicePublicKeyBase64Url, Sa as buildSystemRunApprovalBinding, Sc as getTtsProvider, Sf as normalizeRateLimitClientIp, Sh as normalizeUsageDisplay, So as validateDevicePairListParams, Sp as migrateLegacyConfig, Sr as resolveGroupToolPolicy, Ss as validateWizardStartParams, St as resolveSessionDeliveryTarget, T as isCliProvider, Ta as toSystemRunApprovalMismatchError, Tc as resolveTtsApiKey, Tf as isLoopbackHost, Th as supportsXHighThinking, Ti as clearSessionQueues, Tl as resolveAgentSessionDirs, To as validateDeviceTokenRevokeParams, Tp as parseConfigJson5, Tr as runBeforeToolCallHook, Ts as errorShape, Tu as isGatewayCliClient, Ua as formatValidationErrors, Uc as startDiagnosticHeartbeat, Ui as normalizeRequiredName, Ul as archiveSessionTranscripts, Un as normalizeSendPolicy, Uo as validateNodePairRequestParams, Ur as normalizeSpawnedRunMetadata, Us as isSystemEventContextChanged, Ut as consumeGatewaySigusr1RestartAuthorization, Uu as writeJsonAtomic, V as loadOpenClawPlugins, Va as isNodeRoleMethod, Vc as CommandLane, Vf as enableTailscaleFunnel, Vi as normalizeOptionalText$1, Vn as normalizeMimeList, Vo as validateNodePairListParams, Vr as resolveAgentTimeoutMs, Vs as verifyDeviceSignature, Vt as applyVerboseOverride, Vu as createAsyncLock, Wa as validateAgentIdentityParams, Wc as stopDiagnosticHeartbeat, Wf as getTailnetHostname, Wl as capArrayByJsonBytes, Wn as resolveSendPolicy, Wo as validateNodePairVerifyParams, Wp as parseByteSize, Wr as resolveIngressWorkspaceOverrideForSpawnedRun, Wt as deferGatewayRestartUntilIdle, Xa as validateAgentsFilesListParams, Xf as collectExplicitAllowlist, Xi as prepareSecretsRuntimeSnapshot, Xl as stripEnvelopeFromMessages, Xn as abortEmbeddedPiRun, Xo as validatePushTestParams, Xp as isAvatarHttpUrl, Xs as setHeartbeatsEnabled, Xt as setPreRestartDeferralCheck, Ya as validateAgentsFilesGetParams, Yi as getActiveSecretsRuntimeSnapshot, Yl as stripEnvelopeFromMessage, Yo as validatePollParams, Yp as isAvatarDataUrl, Yr as registerAgentRunContext, Yt as setGatewaySigusr1RestartPolicy, Za as validateAgentsFilesSetParams, Zc as resolveMemorySearchConfig, Zf as mergeAlsoAllowPolicy, Zi as resolveCommandSecretsFromActiveRuntimeSnapshot, Zl as stripInlineDirectiveTagsForDisplay, Zn as getActiveEmbeddedRunCount, Zo as validateRequestFrame, Zp as isAvatarImageDataUrl, Zt as triggerOpenClawRestart, _d as rawDataToString, _i as resolveGatewaySessionStoreTarget, _m as buildTalkConfigResponse, _n as listAgentWorkspaceDirs, _o as validateCronRunParams, _r as applyToolPolicyPipeline, _s as validateWakeParams, _t as normalizePollInput, _u as normalizeChannelId, ad as createBrowserRouteDispatcher, ai as applyModelOverrideToSessionEntry, al as isSilentReplyText, am as applyMergePatch, an as approveNodePairing, ao as validateChatSendParams, as as validateSessionsPreviewParams, at as ensureOutboundSessionEntry, ba as resolveSystemRunApprovalRuntimeContext, bc as OPENAI_TTS_MODELS, bf as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, bh as normalizeReasoningLevel, bo as validateCronUpdateParams, bs as validateWizardCancelParams, bu as resolveAccountEntry, cf as authorizeHttpGatewayConnect, cn as renamePairedNode, co as validateConfigPatchParams, cs as validateSessionsUsageParams, cu as setSessionRuntimeModel, dc as resolvePluginTools, dd as movePathToTrash, df as resolveGatewayAuth, dn as verifyNodeToken, do as validateConfigSchemaParams, dp as SsrFBlockedError, ds as validateSkillsStatusParams, du as resolveExplicitAgentSessionKey, ei as resolveAnnounceTargetFromKey, em as looksLikeAvatarPath, en as recordRemoteNodeInfo, eo as validateChannelsLogoutParams, es as validateSendParams, et as getChannelActivity, eu as jsonUtf8Bytes, fh as DEFAULT_MODEL, fi as listAgentsForGateway, fo as validateConfigSetParams, fs as validateSkillsUpdateParams, ft as normalizeReplyPayloadsForDelivery, fu as resolveMainSessionKey, gf as readGatewayTokenEnv, gi as migrateAndPruneGatewaySessionStoreKey, gn as resolvePairingPaths, go as validateCronRemoveParams, gp as loadModelCatalog, gr as resolveToolLoopDetectionConfig, gs as validateUpdateRunParams, gt as resolveMessageChannelSelection, gu as listChannelPlugins, hc as resolveUserTimezone, hf as readGatewayPasswordEnv, hh as formatXHighModelHint, hi as loadSessionEntry, hl as resolveIdentityName, hn as pruneExpiredPending, ho as validateCronListParams, hp as registerUnhandledRejectionHandler, hr as resolveCronStyleNow, hs as validateToolsCatalogParams, ht as resetDirectoryCache, hu as getChannelPlugin, ic as normalizeExecApprovals, id as fetchBrowserJson, ii as resolvePreferredSessionKeyForSessionIdMatches, in as setSkillsRemoteRegistry, io as validateChatInjectParams, is as validateSessionsPatchParams, jc as setTtsProvider, jf as resolveClientIp, jl as loadSessionStore, jm as runGlobalGatewayStopSafely, jn as resolveSessionAuthProfileOverride, jo as validateExecApprovalsNodeSetParams, jp as writeConfigFile, jr as countActiveDescendantRuns, js as buildDeviceAuthPayloadV3, jt as resolveCronStorePath, ju as GATEWAY_CLIENT_CAPS, k as normalizeModelSelection, kc as resolveTtsProviderOrder, kf as normalizeHostHeader, ki as normalizeGroupActivation, kn as registerSkillsChangeListener, ko as validateExecApprovalsGetParams, kp as resolveConfigSnapshotHash, kr as getHookType, ks as resolveDeviceAuthConnectErrorDetailCode, kt as buildBareSessionResetPrompt, ku as normalizeMessageChannel, lc as saveExecApprovals, lf as authorizeWsControlUiGatewayConnect, ln as requestNodePairing, lo as validateConfigSchemaLookupParams, lp as extractTextFromChatContent, ls as validateSkillsBinsParams, lu as canonicalizeMainSessionAlias, mh as formatThinkingLevels, mi as loadCombinedSessionStoreForGateway, ml as resolveEffectiveMessagesConfig, mo as validateCronAddParams, ms as validateTalkModeParams, mt as maybeResolveIdLikeTarget, mu as snapshotSessionOrigin, na as isKnownSecretTargetId, nc as mergeExecApprovalsSocketDefaults, nn as refreshRemoteNodeBins, no as validateChatAbortParams, np as resolveCoreToolProfiles, nr as resolveBootstrapWarningSignaturesSeen, ns as validateSessionsDeleteParams, nt as createReplyDispatcher, od as createBrowserControlContext, oi as loadProviderUsageSummary, ol as getAcpSessionManager, om as applyLegacyMigrations, on as listNodePairing, oo as validateConfigApplyParams, or as resolveFailoverReasonFromError, os as validateSessionsResetParams, ot as resolveOutboundSessionRoute, ou as mergeSessionEntry, ph as DEFAULT_PROVIDER, pi as listSessionsFromStore, pl as resolveAgentIdentity, pn as verifyPairingToken, po as validateConnectParams, ps as validateTalkConfigParams, pu as resolveMainSessionKeyFromConfig, q as formatHelpExamples, qa as validateAgentsCreateParams, qi as activateSecretsRuntimeSnapshot, ql as readSessionPreviewItemsFromTranscript, qn as CURRENT_MESSAGE_MARKER, qo as validateNodePendingEnqueueParams, qr as getAgentRunContext, qt as markGatewaySigusr1RestartHandled, ri as resolveNestedAgentLane, rl as SILENT_REPLY_TOKEN, rn as removeRemoteNodeInfo, ro as validateChatHistoryParams, rs as validateSessionsListParams, rt as getTotalPendingReplies, sc as readExecApprovalsSnapshot, sd as startBrowserControlServiceFromConfig, sf as assertGatewayAuthConfigured, sm as ensureControlUiAllowedOriginsForNonLoopbackBind, sn as rejectNodePairing, so as validateConfigGetParams, sr as resolveFastModeState, ss as validateSessionsResolveParams, st as deliverOutboundPayloads, tl as stripHeartbeatToken, tn as refreshRemoteBinsForConnectedNodes, to as validateChannelsStatusParams, tp as listCoreToolSections, ts as validateSessionsCompactParams, tt as dispatchInboundMessage, uc as getPluginToolMeta, uf as isLocalDirectRequest, uh as normalizeSecretInput, ui as canonicalizeSpawnedByForAgent, ul as isRestartEnabled, un as updatePairedNodeMetadata, uo as validateConfigSchemaLookupResult, up as fetchWithSsrFGuard, us as validateSkillsInstallParams, uu as resolveAgentMainSessionKey, vc as clearBootstrapSnapshot, vd as cleanOldMedia, vf as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, vh as normalizeElevatedLevel, vi as resolveSessionModelRef, vl as estimateBase64DecodedBytes, vm as resolveAgentMaxConcurrent, vn as formatZonedTimestamp, vo as validateCronRunsParams, vr as buildDefaultToolPolicyPipelineSteps, vs as validateWebLoginStartParams, vu as normalizeWhatsAppTarget, w as getModelRefStatus, wa as missingSystemRunApprovalBinding, wc as isTtsProviderConfigured, wf as isLoopbackAddress, wi as sleepWithAbort, wo as validateDevicePairRemoveParams, wp as loadConfig, ws as ErrorCodes, wt as applyPluginAutoEnable, wu as isDeliverableMessageChannel, x as buildAllowedModelSet, xa as resolveSystemRunCommandRequest, xc as OPENAI_TTS_VOICES, xf as createAuthRateLimiter, xh as normalizeThinkLevel, xi as lookupContextTokens, xo as validateDevicePairApproveParams, xr as resolveEffectiveToolPolicy, xs as validateWizardNextParams, xt as resolveOutboundTarget, ya as resolveSystemRunApprovalRequestContext, yd as saveMediaBuffer, yf as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, yh as normalizeFastMode, ym as resolveSubagentMaxConcurrent, yo as validateCronStatusParams, ys as validateWebLoginWaitParams, yu as resolveChannelDefaultAccountId, z as resolveThinkingDefault, za as WRITE_SCOPE, zc as setCommandLaneConcurrency, zf as disableTailscaleFunnel, zi as normalizeOptionalAgentId, zl as mergeDeliveryContext, zn as extractFileContentFromSource, zo as validateNodeListParams, zs as publicKeyRawBase64UrlFromPem, zu as cleanStaleLockFiles } from "./auth-profiles-DZ4zIQH4.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-lHks6gb9.js";
import { S as isCronRunSessionKey, T as parseAgentSessionKey, _ as normalizeOptionalAccountId, a as classifySessionKeyShape, c as normalizeMainKey, g as normalizeAccountId$1, h as DEFAULT_ACCOUNT_ID, l as resolveAgentIdFromSessionKey, m as toAgentStoreSessionKey, p as toAgentRequestSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID, w as isSubagentSessionKey, x as isAcpSessionKey } from "./session-key-9lbhEIb9.js";
import { _ as shortenHomePath, b as truncateUtf16Safe, h as resolveUserPath, n as clamp, p as resolveConfigDir, s as ensureDir, v as sleep, x as isPlainObject } from "./utils-D0Yqqtk-.js";
import { a as sameFileIdentity, i as openVerifiedFileSync, m as matchesSkillFilter, n as openBoundaryFile, r as openBoundaryFileSync, u as isNotFoundPathError } from "./boundary-file-read-Dra285K5.js";
import { a as logDebug, c as logWarn, n as runExec, t as runCommandWithTimeout } from "./exec-BMx4PoTI.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-DiBSpP88.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BrzD-dBG.js";
import "./github-copilot-token-Dmorf6Ne.js";
import { G as PROTECTED_PLUGIN_ROUTE_PREFIXES, J as clearInternalHooks, K as canonicalizePathForSecurity, R as getActivePluginRegistry, T as isTestDefaultMemorySlotDisabled, U as createEmptyPluginRegistry, X as registerInternalHook, Y as createInternalHookEvent, Z as triggerInternalHook, i as loadWorkspaceSkillEntries, k as CHANNEL_IDS, q as canonicalizePathVariant, r as buildWorkspaceSkillSnapshot, t as resolveSkillsInstallPreferences } from "./skills-NeRNNbEl.js";
import { f as hasBinary } from "./frontmatter-BzGWVIyf.js";
import { p as resolveSkillKey } from "./env-overrides-D54I1R12.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-Yn0NaOik.js";
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-Cs4X-3T9.js";
import { B as readLocalFileSafely, H as writeFileWithinRoot, N as SafeOpenError, V as writeFileFromPathWithinRoot } from "./query-expansion-C-xoIovu.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-Dc1bGBfo.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-BIQILtBT.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-DpKou6ZY.js";
import { c as inspectPortUsage, d as formatPortDiagnostics, s as ensurePortAvailable } from "./cmd-argv-DN-N1T_K.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-C-OA8Ze0.js";
import "./delivery-queue-DCXFvPmD.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CmL1n6G7.js";
import { c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-Zj7Y3VA9.js";
import { t as formatDocsLink } from "./links-BmJbo-zG.js";
import { n as runCommandWithRuntime } from "./cli-utils-Cc7goTOv.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-TkKQQD7k.js";
import { n as resolveBrewExecutable, t as ensureOpenClawCliOnPath } from "./path-env-DRIU5Paa.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CMvz-16P.js";
import { t as readSecretFromFile } from "./secret-file-DwjIX_io.js";
import { n as inheritOptionFromParent } from "./command-options-LK1l2nka.js";
import { t as buildChannelAccountSnapshot } from "./status-CbKxGhJb.js";
import { n as formatConfigIssueLines } from "./issue-format-C8GXLHk1.js";
import "./channels-status-issues-DJuh_W22.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BWfrOWsi.js";
import "./daemon-install-plan.shared-Cp3Ohrwt.js";
import "./runtime-guard-J6FFyZo2.js";
import "./gateway-install-token-DhQTmVZ8.js";
import { C as resolveAssistantAvatarUrl, S as normalizeControlUiBasePath, b as CONTROL_UI_AVATAR_PREFIX, c as handleReset, x as buildControlUiAvatarUrl } from "./onboard-helpers-4CUqO3j0.js";
import "./prompt-style-B3R7Bffy.js";
import "./runtime-parse-pVlvZ5Tt.js";
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-BYHD2rMv.js";
import { c as isGatewayArgv, l as parseProcCmdline } from "./service-B9uQ0VXf.js";
import "./systemd-BJIjjTO2.js";
import "./lifecycle-core-qWFx-YFM.js";
import "./systemd-hints-BRnx3cm_.js";
import { t as parsePort$1 } from "./parse-port-Cv54hy6L.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CTiK3hSy.js";
import { r as probeGateway } from "./probe-auth-BBmbxTvj.js";
import "./diagnostics-hEPUS2XY.js";
import "./inspect-EtxNoo83.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-BfxWlfym.js";
import "./table-Bza8Ia2x.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BYHs7olW.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BN-L2c5D.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-BDO52jmA.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-Epy9yUeO.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Qc9osVeU.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, d as onHeartbeatEvent, f as resolveCronSession, l as resolveHeartbeatVisibility, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as getLastHeartbeatEvent } from "./health-BIaLfF-x.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-DhlZGSiY.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-lWSG1DR8.js";
import { c as writeRestartSentinel, i as formatRestartSentinelMessage, l as checkUpdateStatus, n as consumeRestartSentinel, o as summarizeRestartSentinel, p as resolveNpmChannelTag, r as formatDoctorNonInteractiveHint, u as compareSemverStrings, x as normalizeUpdateChannel } from "./channel-account-context-BPgheM9i.js";
import { t as WizardCancelledError } from "./prompts-BrEAENsf.js";
import { t as runOnboardingWizard } from "./onboarding-pmml8EW1.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-Bxw5QIhR.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-B0Ahx0yO.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, s as loadAgentIdentityFromWorkspace, t as applyAgentConfig } from "./agents.config-C28u20wN.js";
import { i as readChannelAllowFromStoreSync } from "./pairing-store-CkFJMwFX.js";
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-BGditnUc.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent-DV0zE77I.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-Xa3CnNVq.js";
import { _ as resolveHookTargetAgentId, a as getHookAgentPolicyError, b as resolveFunctionModuleExport, c as normalizeAgentPayload, d as normalizeWakePayload, f as readJsonBody, g as resolveHookSessionKey, h as resolveHookIdempotencyKey, i as extractHookToken, l as normalizeHookDispatchSessionKey, m as resolveHookDeliver, n as collectEnabledInsecureOrDangerousFlags, o as getHookChannelError, p as resolveHookChannel, s as isHookAgentAllowed, u as normalizeHookHeaders, v as resolveHooksConfig, y as applyHookMappings } from "./audit-BbChZYY0.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-B6JKo5Zj.js";
import "./node-service-ZKIHeWjw.js";
import "./status.update-HGym_DW_.js";
import { t as isWithinDir } from "./path-safety-C7XgwZ9I.js";
import { c as prepareArchiveDestinationDir, h as isWindowsDrivePath, l as withStagedArchiveDestination, n as extractArchive$1, p as safePathSegmentHashed, s as mergeExtractedTreeIntoDestination, t as createTarEntryPreflightChecker, u as assertCanonicalPathWithinBase } from "./archive-nC1xtUAK.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-COj5oTP1.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-DAq0qX-j.js";
...
function resolveExecApprovalSessionTarget(params) {
	...
	const target = resolveSessionDeliveryTarget({
		...
		turnSourceChannel: normalizeOptionalString$1(params.turnSourceChannel),
		turnSourceTo: normalizeOptionalString$1(params.turnSourceTo),
		turnSourceAccountId: normalizeOptionalString$1(params.turnSourceAccountId),
		turnSourceThreadId: normalizeOptionalThreadId(params.turnSourceThreadId)
	});
	if (!target.to) return null;
	return {
		channel: normalizeOptionalString$1(target.channel),
		to: target.to,
		accountId: normalizeOptionalString$1(target.accountId),
...
function buildTelegramExecApprovalButtons(approvalId) {
	return [[{
		text: "Allow Once",
		callback_data: `/approve ${approvalId} allow-once`
	}, {
		text: "Allow Always",
		callback_data: `/approve ${approvalId} allow-always`
	}], [{
		text: "Deny",
		callback_data: `/approve ${approvalId} deny`
	}]];
}
async function sendTypingTelegram(_to, _params) {}
...
function resolveAvatarSource(cfg, agentId) {
	const fromConfig = normalizeAvatarValue$1(resolveAgentIdentity(cfg, agentId)?.avatar);
	if (fromConfig) return fromConfig;
	return normalizeAvatarValue$1(loadAgentIdentityFromWorkspace(resolveAgentWorkspaceDir(cfg, agentId))?.avatar);
}
...
function resolveWhatsAppAccount(params) {
	...
	return { allowFrom: ((normalizedAccountId ? accounts?.[normalizedAccountId] : void 0) ?? accounts?.default ?? void 0)?.allowFrom ?? params.cfg.channels?.whatsapp?.allowFrom ?? [] };
}
...
//#endregion
//#region src/browser/session-tab-registry.ts
...
async function emitSessionUnboundLifecycleEvent(params) {
	...
	params.targetSessionKey, params.reason;
...
function isSlackInteractiveRepliesEnabled() {
	return false;
}
function createReplyPrefixContext(params) {
	...
	return {
		...
		enableSlackInteractiveReplies: params.channel === "slack" ? isSlackInteractiveRepliesEnabled({
			cfg,
			accountId: params.accountId
		}) : void 0,
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DJsFimDb.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-Zj7Y3VA9.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-oIqYVLL-.js");
...
async function handleA2uiHttpRequest(_req, res) {
	res.statusCode = 404;
...
function isCanvasPath(pathname) {
	return pathname === "/a2ui" || pathname.startsWith(`/a2ui/`) || pathname === "/canvas" || pathname.startsWith(`/canvas/`) || pathname === "/canvas/ws";
}
...
async function handleSlackHttpRequest() {
	return false;
}
...
function attachGatewayUpgradeHandler(opts) {
	...
	httpServer.on("upgrade", (req, socket, head) => {
		(async () => {
			...
			if (scopedCanvas.rewrittenUrl) req.url = scopedCanvas.rewrittenUrl;
			if (canvasHost) {
				if (new URL(req.url ?? "/", "http://localhost").pathname === "/canvas/ws") {
					const configSnapshot = loadConfig();
					const ok = await authorizeCanvasRequest({
						req,
						auth: resolvedAuth,
...
async function createCanvasHostHandler(_params) {
	return {
		rootDir: void 0,
		close: async () => {}
	};
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DCXFvPmD.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./auth-profiles-DZ4zIQH4.js").then((n) => n.ct);
