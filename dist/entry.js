#!/usr/bin/env node
import { Q as isRootVersionInvocation, Y as hasHelpOrVersion, Z as isRootHelpInvocation, t as createSubsystemLogger } from "./subsystem-C1ZwgyXv.js";
import { b as resolveRequiredHomeDir } from "./paths-dQ_clcF4.js";
import { t as isValidProfileName } from "./profile-utils-BLR70_pd.js";
import { t as parseBooleanValue } from "./boolean-BHdNsbzF.js";
...
if (!isMainModule({
	...
	function tryHandleRootVersionFastPath(argv) {
		...
		Promise.all([import("./version-Yn0NaOik.js").then((n) => n.r), import("./git-commit-CT-cnzLN.js").then((n) => n.t)]).then(([{ VERSION }, { resolveCommitHash }]) => {
	...
	function tryHandleRootHelpFastPath(argv) {
		...
		import("./program-CrVrTwjk.js").then(({ buildProgram }) => {
	...
	if (!ensureExperimentalWarningSuppressed()) {
		...
		if (!tryHandleRootVersionFastPath(process$1.argv) && !tryHandleRootHelpFastPath(process$1.argv)) import("./run-main-CMec67MO.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
