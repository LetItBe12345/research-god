...
import { f as defaultRuntime, k as theme, u as stripAnsi } from "./subsystem-C5Ov5Tl6.js";
import { v as shortenHomePath } from "./utils-J_jJJlhx.js";
import { nm as loadConfig } from "./reply-BJBzAldK.js";
...
async function loadSkillsStatusReport() {
	...
	const { buildWorkspaceSkillStatus } = await import("./skills-status-DNDf9bbo.js").then((n) => n.n);
