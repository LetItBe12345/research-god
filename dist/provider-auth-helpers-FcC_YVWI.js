...
import { Al as buildSyntheticModelDefinition, Cl as buildXiaomiProvider, Dl as SYNTHETIC_BASE_URL, El as buildTogetherModelDefinition, Fl as HUGGINGFACE_BASE_URL, Gl as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, Il as HUGGINGFACE_MODEL_CATALOG, Kl as buildCloudflareAiGatewayModelDefinition, Ll as buildHuggingfaceModelDefinition, Ml as VENICE_DEFAULT_MODEL_REF, Nl as VENICE_MODEL_CATALOG, Ol as SYNTHETIC_DEFAULT_MODEL_REF, Pl as buildVeniceModelDefinition, Sh as normalizeSecretInput, Sl as buildQianfanProvider, Th as DEFAULT_PROVIDER, Tl as TOGETHER_MODEL_CATALOG, Ul as KILOCODE_BASE_URL, Wl as KILOCODE_DEFAULT_MODEL_REF, am as readConfigFileSnapshot, at as buildModelAliasIndex, bl as buildKilocodeProvider, bt as resolveModelRefFromString, ch as upsertAuthProfile, gh as resolveOpenClawAgentDir, jl as VENICE_BASE_URL, kl as SYNTHETIC_MODEL_CATALOG, lm as writeConfigFile, lt as legacyModelKey, pt as normalizeProviderId, ql as resolveCloudflareAiGatewayBaseUrl, ut as modelKey, vl as QIANFAN_DEFAULT_MODEL_ID, wl as TOGETHER_BASE_URL, xl as buildKimiCodingProvider, yl as XIAOMI_DEFAULT_MODEL_ID } from "./reply-BJBzAldK.js";
import { F as toAgentModelListLike, r as listAgentIds } from "./agent-scope-mSwAEzsR.js";
import { s as normalizeAgentId } from "./session-key-COcqKA5t.js";
import { i as coerceSecretRef, t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-BlmM3Rpg.js";
import { t as formatCliCommand } from "./command-format-CEAcyghQ.js";
import { t as PROVIDER_ENV_VARS } from "./provider-env-vars-CbN1XugP.js";
import { n as formatConfigIssueLines } from "./issue-format-C8GUIW_E.js";
import { n as isWSLEnv } from "./wsl-BGkKxIEt.js";
