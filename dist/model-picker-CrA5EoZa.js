...
import { A as normalizeProviderId, B as resolvePluginProviders, Cm as hasUsableCustomProviderApiKey, D as modelKey, Em as resolveEnvApiKey, P as resolveConfiguredModelRef, S as buildModelAliasIndex, d as listProfilesForProvider, fh as DEFAULT_MODEL, gp as loadModelCatalog, m as ensureAuthProfileStore, p as upsertAuthProfile, ph as DEFAULT_PROVIDER, x as buildAllowedModelSet, yp as resolveOpenClawAgentDir } from "./auth-profiles-DZ4zIQH4.js";
import { P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir } from "./agent-scope-lHks6gb9.js";
import { f as openUrl } from "./onboard-helpers-4CUqO3j0.js";
import { Zt as formatTokenK, a as OPENAI_CODEX_DEFAULT_MODEL, c as isRemoteEnvironment, i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, s as createVpsAwareOAuthHandlers, t as applyDefaultModel, y as applyAuthProfileConfig } from "./provider-auth-helpers-CIILB8Ym.js";
import { t as enablePluginInConfig } from "./enable-B88Ork4A.js";
import { a as runProviderModelSelectedHook, n as resolveProviderModelPickerEntries, r as resolveProviderPluginChoice } from "./provider-wizard-Di6BkcUS.js";
...
async function applyAuthChoicePluginProvider(params, options) {
	...
	if (applied.defaultModel) {
		if (params.setDefaultModel) {
			...
			agentModelOverride = applied.defaultModel;
			await params.prompter.note(`Default model set to ${applied.defaultModel} for agent "${params.agentId}".`, "Model configured");
		}
	}
	return {
		config: nextConfig,
...
async function promptDefaultModel(params) {
	...
	if (includeProviderPluginSetups && agentDir) options.push(...resolveProviderModelPickerEntries({
		config: cfg,
	...
	const pluginResolution = selection.startsWith("provider-plugin:") ? selection : selection.includes("/") ? null : pluginProviders.some((provider) => normalizeProviderId(provider.id) === normalizeProviderId(selection)) ? selection : null;
	if (pluginResolution) {
...
//#endregion
export { promptDefaultModel as a, applyAuthChoicePluginProvider as c, model_picker_exports as i, applyModelFallbacksFromSelection as n, promptModelAllowlist as o, applyPrimaryModel as r, applyAuthChoiceLoadedPluginProvider as s, applyModelAllowlist as t };
