import { B as resolvePreferredOpenClawTmpDir, t as createSubsystemLogger, x as logVerbose } from "./subsystem-C1ZwgyXv.js";
import { h as resolveUserPath, p as resolveConfigDir, t as CONFIG_DIR, u as isRecord } from "./utils-D0Yqqtk-.js";
import { d as isPathInside$1, h as normalizeSkillFilter, r as openBoundaryFileSync } from "./boundary-file-read-Dra285K5.js";
import { n as resolveOpenClawPackageRootSync } from "./openclaw-root-DiBSpP88.js";
import { m as MANIFEST_KEY } from "./frontmatter-BzGWVIyf.js";
import { d as resolveOpenClawMetadata, f as resolveSkillInvocationPolicy, l as shouldIncludeSkill, u as parseFrontmatter } from "./env-overrides-D54I1R12.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-Fe1oJGGa.js";
...
//#endregion
export { resolveContextEngine as $, CHAT_CHANNEL_ORDER as A, getActivePluginRegistryVersion as B, resolvePackageExtensionEntries as C, resolveEffectiveEnableState as D, normalizePluginsConfig as E, normalizeAnyChannelId as F, PROTECTED_PLUGIN_ROUTE_PREFIXES as G, setActivePluginRegistry as H, normalizeChannelId as I, clearInternalHooks as J, canonicalizePathForSecurity as K, normalizeChatChannelId as L, formatChannelSelectionLine as M, getChatChannelMeta as N, resolveMemorySlotDecision as O, listChatChannels as P, registerContextEngine as Q, getActivePluginRegistry as R, loadPluginManifest as S, isTestDefaultMemorySlotDisabled as T, createEmptyPluginRegistry as U, requireActivePluginRegistry as V, createPluginRegistry as W, registerInternalHook as X, createInternalHookEvent as Y, triggerInternalHook as Z, discoverOpenClawPlugins as _, resolveSkillsPromptForRun as a, matchPluginCommand as at, isPathInside as b, resolveBundledSkillsDir as c, resolveSandboxInputPath as d, applyExclusiveSlotSelection as et, resolveSandboxPath as f, clearPluginDiscoveryCache as g, loadPluginManifestRegistry as h, loadWorkspaceSkillEntries as i, listPluginCommands as it, formatChannelPrimerLine as j, CHANNEL_IDS as k, assertMediaNotDataUrl as l, clearPluginManifestRegistryCache as m, buildWorkspaceSkillCommandSpecs as n, clearPluginCommands as nt, syncSkillsToWorkspace as o, resolveSandboxedMediaSource as p, canonicalizePathVariant as q, buildWorkspaceSkillSnapshot as r, executePluginCommand as rt, resolvePluginSkillDirs as s, resolveSkillsInstallPreferences as t, defaultSlotIdForKey as tt, assertSandboxPath as u, resolvePluginCacheInputs as v, applyTestPluginDefaults as w, safeStatSync as x, resolvePluginSourceRoots as y, getActivePluginRegistryKey as z };
