...
import { Dp as readConfigFileSnapshot, jp as writeConfigFile } from "./auth-profiles-DZ4zIQH4.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-4CUqO3j0.js").then((n) => n.d);
	...
	const { applyOnboardingLocalWorkspaceConfig } = await import("./onboard-config-CH1zk80A.js").then((n) => n.n);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-BPQ7963E.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-DC3Sqwyp.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-BEVaOqGl.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-CrA5EoZa.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-rZppwiQD.js");
	...
	const { logConfigUpdated } = await import("./logging-D3TCKWkc.js").then((n) => n.r);
	logConfigUpdated(runtime);
	await onboardHelpers.ensureWorkspaceAndSessions(workspaceDir, runtime, { skipBootstrap: true });
	const { setupInternalHooks } = await import("./onboard-hooks-ChN0_3uG.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-B-FJjHmX.js");
