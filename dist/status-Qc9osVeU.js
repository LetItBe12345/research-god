...
import { O as isRich, k as theme, v as info } from "./subsystem-C1ZwgyXv.js";
import { u as resolveGatewayPort } from "./paths-dQ_clcF4.js";
import { $ as resolveCommandSecretRefsViaGateway, Aa as callGateway, Cn as resolveChannelAccountConfigured, Dp as readConfigFileSnapshot, En as hasResolvedCredentialValue, Ep as readBestEffortConfig, G as withProgress, Gf as readTailscaleStatusJson, Gs as peekSystemEvents, P as resolveConfiguredModelRef, Q as getStatusCommandSecretTargetIds, Qt as getRemoteSkillEligibility, Si as resolveContextTokensForModel, Sn as formatChannelAllowFrom, Tn as hasConfiguredUnavailableCredentialStatus, Wf as getTailnetHostname, bi as formatTimeAgo, bn as inspectReadOnlyChannelAccount, di as classifySessionKey, fh as DEFAULT_MODEL, fi as listAgentsForGateway, fu as resolveMainSessionKey, gu as listChannelPlugins, jl as loadSessionStore, ka as buildGatewayConnectionDetails, ma as formatDurationPrecise, oi as loadProviderUsageSummary, ph as DEFAULT_PROVIDER, rr as sha256HexPrefix, si as formatUsageReportLines, su as resolveFreshSessionTotalTokens, vi as resolveSessionModelRef, wn as resolveChannelAccountEnabled, wp as loadConfig, xn as buildChannelAccountSnapshot, yn as buildChannelSummary, yu as resolveChannelDefaultAccountId } from "./auth-profiles-DZ4zIQH4.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { d as resolveAgentWorkspaceDir } from "./agent-scope-lHks6gb9.js";
import { T as parseAgentSessionKey } from "./session-key-9lbhEIb9.js";
import { n as runExec } from "./exec-BMx4PoTI.js";
...
import { t as getMemorySearchManager } from "./search-manager-Cs4X-3T9.js";
...
import { t as formatConfigIssueLine } from "./issue-format-C8GXLHk1.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DJuh_W22.js";
import { S as normalizeControlUiBasePath, g as resolveControlUiLinks } from "./onboard-helpers-4CUqO3j0.js";
import { c as resolveGatewayLogPaths } from "./launchd-BYHD2rMv.js";
import { n as resolveGatewayService } from "./service-B9uQ0VXf.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-C-avPhKs.js";
...
import { o as resolveHeartbeatSummaryForAgent, t as formatHealthChannelLines } from "./health-BIaLfF-x.js";
import { C as resolveUpdateChannelDisplay, a as readRestartSentinel, f as formatGitInstallLabel, l as checkUpdateStatus, o as summarizeRestartSentinel, t as resolveDefaultChannelAccountContext, x as normalizeUpdateChannel } from "./channel-account-context-BPgheM9i.js";
import { t as runSecurityAudit } from "./audit-BbChZYY0.js";
import { t as resolveNodeService } from "./node-service-ZKIHeWjw.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-1LLawgRu.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-HGym_DW_.js";
import { t as shortenText } from "./text-format-Bhq-nccB.js";
...
async function getAgentLocalStatuses(cfg = loadConfig()) {
	const agentList = listAgentsForGateway(cfg);
	const now = Date.now();
	const statuses = [];
