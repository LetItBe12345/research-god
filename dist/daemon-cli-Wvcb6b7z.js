...
import { g as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-tuenh9TL.js";
import { D as colorize, M as getResolvedLoggerSettings, O as isRich, f as defaultRuntime, k as theme } from "./subsystem-C5Ov5Tl6.js";
import { v as shortenHomePath, y as sleep } from "./utils-J_jJJlhx.js";
import { Ff as trimToUndefined, Kc as isRestartEnabled, Ot as withProgress, Xf as resolveGatewayBindHost, ep as pickPrimaryTailnetIPv4, hd as GATEWAY_CLIENT_NAMES, hs as loadGatewayTlsRuntime, im as readBestEffortConfig, md as GATEWAY_CLIENT_MODES, tm as createConfigIO, ua as callGateway } from "./reply-BJBzAldK.js";
import { t as formatCliCommand } from "./command-format-CEAcyghQ.js";
import { d as inspectPortUsage, m as formatPortDiagnostics, o as killProcessTree, p as classifyPortListener } from "./cmd-argv-C0hFDCCx.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel, x as parseStrictPositiveInteger } from "./constants-B3PtiJ-E.js";
...
import { n as buildGatewayInstallPlan, t as resolveGatewayInstallToken } from "./gateway-install-token-D1P6RtKd.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-3pRKLH22.js";
import { g as resolveControlUiLinks } from "./onboard-helpers-BEzP-_2l.js";
import { n as isWSLEnv } from "./wsl-BGkKxIEt.js";
import { c as resolveGatewayLogPaths } from "./launchd-DNJatA35.js";
import { a as findVerifiedGatewayListenerPidsOnPortSync, n as resolveGatewayService, o as formatGatewayPidList, s as signalVerifiedGatewayPidSync } from "./service-ChJv9xB3.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-Q_z7_aO1.js";
import { _ as installDaemonServiceAndEmit, a as createCliStatusTextStyles, c as filterDaemonEnv, d as pickProbeHostForBind, f as renderGatewayServiceStartHints, g as buildDaemonServiceSnapshot, h as safeDaemonEnv, i as runServiceUninstall, l as normalizeListenerAddress, m as resolveRuntimeStatusColor, n as runServiceStart, o as createDaemonInstallActionContext, p as renderRuntimeHints, r as runServiceStop, s as failIfNixDaemonInstallMode, t as runServiceRestart, u as parsePortFromArgs } from "./lifecycle-core-Dsd2JklI.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-aR9JOr8y.js";
import { t as parsePort } from "./parse-port-DLKd_Xkw.js";
import { n as resolveGatewayProbeAuthWithSecretInputs, r as probeGateway } from "./probe-auth-uI6xex5k.js";
...
async function gatherDaemonStatus(opts) {
	...
	const { mergedDaemonEnv, cliCfg, daemonCfg, cliConfigSummary, daemonConfigSummary, configMismatch } = await loadDaemonConfigContext(command?.environment).catch(() => ({
		mergedDaemonEnv: { ...process.env },
		cliCfg: {},
		daemonCfg: {},
		cliConfigSummary: {
...
async function runDaemonStatus(opts) {
	try {
		...
		try {
			...
			defaultRuntime.error(colorize(rich, theme.error, `Gateway status rendering failed: ${String(err)}`));
