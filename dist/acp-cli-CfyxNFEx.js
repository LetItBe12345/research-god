...
import { $m as VERSION, Sa as GatewayClient, hd as GATEWAY_CLIENT_NAMES, kh as listThinkingLevels, la as buildGatewayConnectionDetails, ma as resolveGatewayCredentialsWithSecretInputs, md as GATEWAY_CLIENT_MODES, nm as loadConfig, yp as isKnownCoreToolId } from "./reply-BJBzAldK.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-FbPYVnkg.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-CbN1XugP.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-ChkCY4v8.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-B1z7yY2E.js");
