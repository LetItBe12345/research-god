...
import { p as restoreTerminalState } from "./subsystem-C5Ov5Tl6.js";
import { g as resolveUserPath, p as pathExists } from "./utils-J_jJJlhx.js";
import "./reply-BJBzAldK.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-mSwAEzsR.js";
import "./openclaw-root-BWGgUZ_i.js";
import "./exec-DUrziqOt.js";
import "./github-copilot-token-BpS_ZjgB.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-CEAcyghQ.js";
...
import { f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint, y as waitForGatewayReachable } from "./onboard-helpers-BEzP-_2l.js";
...
import { i as isSystemdUserServiceAvailable } from "./systemd-Q_z7_aO1.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DKaZ5KRi.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CrwWnGiW.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CrwWnGiW.js");
