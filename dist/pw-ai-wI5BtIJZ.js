import { B as resolvePreferredOpenClawTmpDir } from "./subsystem-C1ZwgyXv.js";
import "./paths-dQ_clcF4.js";
import "./boolean-BHdNsbzF.js";
import { $u as appendCdpPath, Ad as assertBrowserNavigationRedirectChainAllowed, Cd as resolveStrictExistingPathsWithinRoot, Ju as buildRoleSnapshotFromAriaSnapshot, Md as withBrowserNavigationPolicy, Od as BrowserTabNotFoundError, Qu as normalizeCdpWsUrl, Xu as parseRoleRef, Yu as getRoleSnapshotStats, Zu as formatAriaSnapshot, bd as DEFAULT_TRACE_DIR, ed as fetchJson, fd as getChromeWebSocketUrl, gd as withNoProxyForCdpUrl, jd as assertBrowserNavigationResultAllowed, kd as assertBrowserNavigationAllowed, nd as normalizeCdpHttpBaseForJsonEndpoints, pd as markPwAiLoaded, qu as buildRoleSnapshotFromAiSnapshot, rd as withCdpSocket, td as getHeadersWithAuth, wd as matchBrowserUrlPattern, xd as DEFAULT_UPLOAD_DIR } from "./auth-profiles-DZ4zIQH4.js";
...
import { V as writeFileFromPathWithinRoot } from "./query-expansion-C-xoIovu.js";
import "./redact-Dc1bGBfo.js";
import { r as formatErrorMessage } from "./errors-BIQILtBT.js";
