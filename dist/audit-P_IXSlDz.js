import { g as resolveStateDir, m as resolveOAuthDir, o as resolveConfigPath, t as CONFIG_PATH } from "./paths-tuenh9TL.js";
import { $n as isToolAllowedByPolicies, Im as normalizeTrustedSafeBinDirs, Jc as resolveNativeSkillsEnabled, Jd as resolveBrowserConfig, Jm as INCLUDE_KEY, Jp as inspectPathPermissions, Js as resolveMergedSafeBinProfileFixtures, K as inspectReadOnlyChannelAccount, Kp as formatPermissionDetail, Q as hasResolvedCredentialValue, Tp as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, W as listAgentWorkspaceDirs, Yd as resolveProfile, Yp as safeStat, Z as hasConfiguredUnavailableCredentialStatus, Zu as listChannelPlugins, _p as resolveToolProfilePolicy, bm as isDangerousNetworkMode, ed as resolveChannelDefaultAccountId, fp as resolveSandboxConfigForAgent, gf as resolveBrowserControlAuth, kf as resolveGatewayAuth, la as buildGatewayConnectionDetails, mp as resolveSandboxToolPolicyForAgent, qc as resolveNativeCommandsEnabled, qp as formatPermissionRemediation, qs as listInterpreterLikeSafeBins, rr as pickSandboxToolPolicy, tm as createConfigIO, ud as normalizeMessageChannel, vd as execDockerRaw, xm as normalizeNetworkMode, yd as getBlockedBindReason } from "./reply-BJBzAldK.js";
import { N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, f as resolveDefaultAgentId, r as listAgentIds } from "./agent-scope-mSwAEzsR.js";
import { T as parseAgentSessionKey, s as normalizeAgentId } from "./session-key-COcqKA5t.js";
...
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-wBkcRuhH.js";
import { E as normalizePluginsConfig, i as loadWorkspaceSkillEntries } from "./skills-yYj6k7r6.js";
...
import { r as probeGateway, t as resolveGatewayProbeAuthSafe } from "./probe-auth-uI6xex5k.js";
import { r as readChannelAllowFromStore } from "./pairing-store-4edGL0s-.js";
import { r as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-D5nA3oTz.js";
import { l as isDangerousNameMatchingEnabled, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-VPWq4qWE.js";
