...
import { D as colorize, O as isRich$1, f as defaultRuntime, k as theme } from "./subsystem-C5Ov5Tl6.js";
import { v as shortenHomePath } from "./utils-J_jJJlhx.js";
import { Ct as resolvePluginProviders, Fp as resolveSecretRefString, Gn as discoverAuthStorage, Hn as resolveModelWithRegistry, Hr as resolveUsageProviderId, It as resolveCommandSecretRefsViaGateway, Jl as resolveAuthProfileEligibility, Kn as discoverModels, Nt as getModelsCommandSecretTargetIds, On as runEmbeddedPiAgent, Rn as describeFailoverError, Sm as parseDurationMs, Th as DEFAULT_PROVIDER, Vl as isNonSecretApiKeyMarker, Vr as formatUsageWindowSummary, Xl as clearAuthProfileCooldown, Yl as resolveAuthProfileOrder, Zl as resolveProfileUnusableUntilForDisplay, _t as resolveConfiguredModelRef, at as buildModelAliasIndex, bt as resolveModelRefFromString, ch as upsertAuthProfile, cl as shouldSuppressBuiltInModel, cm as setRuntimeConfigSnapshot, d as DEFAULT_OAUTH_WARN_MS, dh as loadAuthProfileStoreForRuntime, dl as resolveApiKeyForProvider, f as buildAuthHealthSummary, fl as resolveAwsSdkEnvVarName, gh as resolveOpenClawAgentDir, hh as resolveAuthStorePathForDisplay, kt as withProgressTotals, lh as ensureAuthProfileStore, ll as getCustomProviderApiKey, ml as resolveUsableCustomProviderApiKey, mt as parseModelRef, nh as getShellEnvAppliedKeys, nm as loadConfig, oh as listProfilesForProvider, ol as loadModelCatalog, om as readConfigFileSnapshotForWrite, ot as findNormalizedProviderValue, p as formatRemainingShort, pl as resolveEnvApiKey, pt as normalizeProviderId, rh as shouldEnableShellEnvFallback, sh as setAuthProfileOrder, tm as createConfigIO, u as maskApiKey, ul as hasUsableCustomProviderApiKey, ut as modelKey, vh as resolveAuthProfileDisplayLabel, vt as resolveDefaultModelForAgent, wh as DEFAULT_MODEL, zr as loadProviderUsageSummary } from "./reply-BJBzAldK.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-mSwAEzsR.js";
import { r as normalizeStringEntries } from "./string-normalization-KVM9_eC_.js";
import "./openclaw-root-BWGgUZ_i.js";
import "./exec-DUrziqOt.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-BlmM3Rpg.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CCtAY9XW.js";
import "./session-cost-usage-CPJEuaoV.js";
import { t as formatDocsLink } from "./links-CQdKVoyv.js";
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-DOT-XcGX.js";
...
import { t as inferParamBFromIdOrName } from "./model-param-b-QVeoESfq.js";
import { n as redactSecrets } from "./format-BJYUkP1X.js";
import { $t as loadValidConfigOrThrow, Jt as applyDefaultModelPrimaryUpdate, Lt as writeOAuthCredentials, Qt as isLocalBaseUrl, Xt as formatMs, Yt as ensureFlagCompatibility, Zt as formatTokenK, a as OPENAI_CODEX_DEFAULT_MODEL, an as updateConfig, c as isRemoteEnvironment, en as mergePrimaryFallbackConfig, i as resolveProviderMatch, in as resolveModelTarget, n as mergeConfigPatch, nn as resolveKnownAgentId, o as applyOpenAICodexModelDefault, on as upsertCanonicalModelConfigEntry, r as pickAuthMethod, rn as resolveModelKeysFromEntries, s as createVpsAwareOAuthHandlers, t as applyDefaultModel, tn as normalizeAlias, y as applyAuthProfileConfig } from "./provider-auth-helpers-FcC_YVWI.js";
...
import { t as createClackPrompter } from "./clack-prompter-DR0CSNKU.js";
import { n as validateAnthropicSetupToken } from "./auth-token-q6o80EnQ.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./reply-BJBzAldK.js").then((n) => n.sl);
