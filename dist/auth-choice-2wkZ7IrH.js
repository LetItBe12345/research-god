...
import { Ap as CHUTES_AUTHORIZE_ENDPOINT, Gl as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, Ml as VENICE_DEFAULT_MODEL_REF, Mp as generateChutesPkce, Np as parseOAuthCallbackInput, Ol as SYNTHETIC_DEFAULT_MODEL_REF, Rl as discoverHuggingfaceModels, Uf as isLoopbackHost, Wl as KILOCODE_DEFAULT_MODEL_REF, Yl as resolveAuthProfileOrder, ch as upsertAuthProfile, jp as exchangeChutesCodeForTokens, lh as ensureAuthProfileStore, oh as listProfilesForProvider, ol as loadModelCatalog, pl as resolveEnvApiKey, ul as hasUsableCustomProviderApiKey, vt as resolveDefaultModelForAgent, zl as isHuggingfacePolicyLocked } from "./reply-BJBzAldK.js";
import { F as toAgentModelListLike } from "./agent-scope-mSwAEzsR.js";
import { f as openUrl } from "./onboard-helpers-BEzP-_2l.js";
import { $ as applyLitellmProviderConfig, A as applyModelStudioProviderConfig, At as setTogetherApiKey, B as applySyntheticConfig, Bt as MODELSTUDIO_DEFAULT_MODEL_REF, C as applyKilocodeProviderConfig, Ct as setMoonshotApiKey, D as applyMistralProviderConfig, Dt as setOpenrouterApiKey, E as applyMistralConfig, Et as setOpencodeZenApiKey, F as applyMoonshotProviderConfigCn, Ft as setXiaomiApiKey, G as applyVeniceProviderConfig, H as applyTogetherConfig, Ht as QIANFAN_DEFAULT_MODEL_REF, I as applyOpenrouterConfig, It as setZaiApiKey, J as applyXiaomiConfig, K as applyXaiConfig, L as applyOpenrouterProviderConfig, Lt as writeOAuthCredentials, M as applyMoonshotConfig, Mt as setVercelAiGatewayApiKey, N as applyMoonshotConfigCn, Nt as setVolcengineApiKey, O as applyModelStudioConfig, Ot as setQianfanApiKey, P as applyMoonshotProviderConfig, Pt as setXaiApiKey, Q as applyLitellmConfig, R as applyQianfanConfig, Rt as KIMI_CODING_MODEL_REF, S as applyKilocodeConfig, St as setModelStudioApiKey, T as applyKimiCodeProviderConfig, Tt as setOpencodeGoApiKey, U as applyTogetherProviderConfig, Ut as XAI_DEFAULT_MODEL_REF, V as applySyntheticProviderConfig, Vt as MOONSHOT_DEFAULT_MODEL_REF, W as applyVeniceConfig, X as applyZaiConfig, Y as applyXiaomiProviderConfig, Z as applyZaiProviderConfig, _ as applyMinimaxApiProviderConfig, _t as setKilocodeApiKey, a as OPENAI_CODEX_DEFAULT_MODEL, at as HUGGINGFACE_DEFAULT_MODEL_REF, bt as setMinimaxApiKey, c as isRemoteEnvironment, ct as TOGETHER_DEFAULT_MODEL_REF, d as OPENCODE_GO_DEFAULT_MODEL_REF, dt as ZAI_DEFAULT_MODEL_REF, et as applyCloudflareAiGatewayConfig, ft as setAnthropicApiKey, g as applyMinimaxApiConfigCn, gt as setHuggingfaceApiKey, h as applyMinimaxApiConfig, ht as setGeminiApiKey, it as applyAgentDefaultModelPrimary, j as applyModelStudioProviderConfigCn, jt as setVeniceApiKey, k as applyModelStudioConfigCn, kt as setSyntheticApiKey, l as applyOpencodeGoConfig, lt as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, m as applyOpencodeZenProviderConfig, mt as setCloudflareAiGatewayConfig, nt as applyVercelAiGatewayConfig, o as applyOpenAICodexModelDefault, ot as LITELLM_DEFAULT_MODEL_REF, p as applyOpencodeZenConfig, pt as setByteplusApiKey, q as applyXaiProviderConfig, rt as applyVercelAiGatewayProviderConfig, s as createVpsAwareOAuthHandlers, st as OPENROUTER_DEFAULT_MODEL_REF, tt as applyCloudflareAiGatewayProviderConfig, u as applyOpencodeGoProviderConfig, ut as XIAOMI_DEFAULT_MODEL_REF, v as applyMinimaxApiProviderConfigCn, vt as setKimiCodingApiKey, w as applyKimiCodeConfig, wt as setOpenaiApiKey, x as applyHuggingfaceProviderConfig, xt as setMistralApiKey, y as applyAuthProfileConfig, yt as setLitellmApiKey, z as applyQianfanProviderConfig, zt as MISTRAL_DEFAULT_MODEL_REF } from "./provider-auth-helpers-FcC_YVWI.js";
import { n as githubCopilotLoginCommand, t as loginOpenAICodexOAuth } from "./openai-codex-oauth-DSKnNEpp.js";
import { n as validateAnthropicSetupToken, t as buildTokenProfileId } from "./auth-token-q6o80EnQ.js";
import { a as normalizeSecretInputModeInput, c as resolveSecretInputModeForEnvSelection, d as normalizeApiKeyInput, f as validateApiKeyInput, i as ensureApiKeyFromOptionEnvOrPrompt, l as applyDefaultModelChoice, n as createAuthChoiceDefaultModelApplierForMutableState, o as normalizeTokenProviderInput, s as promptSecretRefForOnboarding, t as createAuthChoiceAgentModelNoter, u as ensureModelAllowlistEntry } from "./auth-choice.apply-helpers-D0TIfgaV.js";
import { a as detectZaiEndpoint, i as applyOpenAIProviderConfig, n as OPENAI_DEFAULT_MODEL, o as GOOGLE_GEMINI_DEFAULT_MODEL, r as applyOpenAIConfig, s as applyGoogleGeminiModelDefault, t as resolvePreferredProviderForAuthChoice } from "./auth-choice.preferred-provider-D2z5r8cZ.js";
import { c as applyAuthChoicePluginProvider, r as applyPrimaryModel, s as applyAuthChoiceLoadedPluginProvider } from "./model-picker-DYEdKdlD.js";
...
async function applySimpleAuthChoiceApiProvider({ params, authChoice, config, setConfig, getConfig, normalizedTokenProvider, requestedSecretInputMode, applyProviderDefaultModel, getAgentModelOverride }) {
	const simpleApiKeyProviderFlow = SIMPLE_API_KEY_PROVIDER_FLOWS[authChoice];
	if (!simpleApiKeyProviderFlow) return null;
...
async function applyAuthChoiceApiProviders(params) {
	...
	if (simpleProviderResult) return simpleProviderResult;
...
async function applyAuthChoiceMiniMax(params) {
	if (params.authChoice === "minimax-global-oauth") return await applyAuthChoicePluginProvider(params, {
	...
	if (params.authChoice === "minimax-cn-oauth") return await applyAuthChoicePluginProvider(params, {
	...
	if (params.authChoice === "minimax-global-api" || params.authChoice === "minimax-cn-api") {
		...
		const promptMessage = `Enter MiniMax ${isCn ? "CN " : ""}API key (sk-api- or sk-cp-)\n${isCn ? "https://platform.minimaxi.com/user-center/basic-information/interface-key" : "https://platform.minimax.io/user-center/basic-information/interface-key"}`;
		let nextConfig = params.config;
		let agentModelOverride;
		const applyProviderDefaultModel = createAuthChoiceDefaultModelApplierForMutableState(params, () => nextConfig, (config) => nextConfig = config, () => agentModelOverride, (model) => agentModelOverride = model);
		const requestedSecretInputMode = normalizeSecretInputModeInput(params.opts?.secretInputMode);
		const otherProfileId = isCn ? "minimax:global" : "minimax:cn";
		const noteMessage = Boolean(nextConfig.auth?.profiles?.[otherProfileId]) ? `Note: Global and CN both use the "minimax" provider entry. Saving this key will overwrite the existing ${isCn ? "Global" : "CN"} endpoint (${otherProfileId}).` : void 0;
		await ensureApiKeyFromOptionEnvOrPrompt({
			token: params.opts?.token,
			tokenProvider: params.opts?.tokenProvider,
			secretInputMode: requestedSecretInputMode,
			...
			prompter: params.prompter,
			noteMessage,
			setCredential: async (apiKey, mode) => setMinimaxApiKey(apiKey, params.agentDir, profileId, { secretInputMode: mode })
		});
		nextConfig = applyAuthProfileConfig(nextConfig, {
			profileId,
			provider: "minimax",
		...
		await applyProviderDefaultModel({
			...
			applyDefaultConfig: (config) => isCn ? applyMinimaxApiConfigCn(config) : applyMinimaxApiConfig(config),
			applyProviderConfig: (config) => isCn ? applyMinimaxApiProviderConfigCn(config) : applyMinimaxApiProviderConfig(config)
		});
		return {
			config: nextConfig,
			agentModelOverride
...
async function warnIfModelConfigLooksOff(config, prompter, options) {
	...
	if (!hasProfile && !envKey && !hasCustomKey) warnings.push(`No auth configured for provider "${ref.provider}". The agent may fail until credentials are added.`);
...
//#endregion
export { warnIfModelConfigLooksOff as n, applyAuthChoice as r, auth_choice_exports as t };
