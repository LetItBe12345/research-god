import { t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-tuenh9TL.js";
import { f as defaultRuntime } from "./subsystem-C5Ov5Tl6.js";
import { g as resolveUserPath, v as shortenHomePath } from "./utils-J_jJJlhx.js";
import { Ot as withProgress, Wf as isSecureWebSocketUrl, Xu as getChannelPlugin, Zu as listChannelPlugins, am as readConfigFileSnapshot, lh as ensureAuthProfileStore, lm as writeConfigFile, nm as loadConfig, sp as findTailscaleBinary, vm as resolveDefaultSecretProviderAlias } from "./reply-BJBzAldK.js";
import { j as resolveDefaultAgentWorkspaceDir } from "./agent-scope-mSwAEzsR.js";
import "./openclaw-root-BWGgUZ_i.js";
import "./exec-DUrziqOt.js";
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BlmM3Rpg.js";
...
import { _ as summarizeExistingConfig, a as ensureWorkspaceAndSessions, g as resolveControlUiLinks, h as randomToken, m as probeGatewayReachable, n as applyWizardMetadata, p as printWizardHeader, r as detectBinary, s as guardCancel, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as validateGatewayPasswordInput, y as waitForGatewayReachable } from "./onboard-helpers-BEzP-_2l.js";
...
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-Q_z7_aO1.js";
import { n as resolveWideAreaDiscoveryDomain } from "./widearea-dns-BC7bXgBb.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-BrUlKud5.js";
import { r as healthCommand } from "./health-BYvOcIvf.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-D2BGJ2Pb.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-DRiWSVsZ.js";
...
import { r as applyAuthChoice } from "./auth-choice-2wkZ7IrH.js";
import { t as resolvePreferredProviderForAuthChoice } from "./auth-choice.preferred-provider-D2z5r8cZ.js";
import { a as promptDefaultModel, n as applyModelFallbacksFromSelection, o as promptModelAllowlist, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-DYEdKdlD.js";
import { n as setupChannels, t as noteChannelStatus } from "./onboard-channels-Bd1z4Tkg.js";
...
import { a as promptCustomApiConfig } from "./onboard-custom-D69VnmPk.js";
...
async function setupSkills(cfg, _workspaceDir, runtime, prompter) {
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, applySearchKey, hasKeyInEnv } = await import("./onboard-search-CrwWnGiW.js");
...
//#endregion
export { configureCommandFromSectionsArg, CONFIGURE_WIZARD_SECTIONS as t };
