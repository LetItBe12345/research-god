import { M as getResolvedLoggerSettings, f as defaultRuntime } from "./subsystem-C1ZwgyXv.js";
import { b as resolveRequiredHomeDir, d as resolveIsNixMode, g as resolveStateDir, m as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-dQ_clcF4.js";
import { i as isTruthyEnvValue$1 } from "./entry.js";
import { Aa as callGateway, At as loadCronStore, Bt as formatRemainingShort, Dh as CLAUDE_CLI_PROFILE_ID, Dp as readConfigFileSnapshot, I as resolveHooksGmailModel, Jf as resolveSandboxScope, Mf as resolveGatewayBindHost, Mt as saveCronStore, Oh as CODEX_CLI_PROFILE_ID, P as resolveConfiguredModelRef, Rt as DEFAULT_OAUTH_WARN_MS, Su as isPrimarySessionTranscriptFileName, Tf as isLoopbackHost, Tl as resolveAgentSessionDirs, V as loadOpenClawPlugins, Xc as hasConfiguredMemorySecretInput, Zc as resolveMemorySearchConfig, _c as resolveBootstrapContextForRun, a as resolveApiKeyForProfile, ap as DEFAULT_SANDBOX_IMAGE, cp as resolveBootstrapTotalMaxChars, df as resolveGatewayAuth, er as analyzeBootstrapBudget, fh as DEFAULT_MODEL, fu as resolveMainSessionKey, gf as readGatewayTokenEnv, gp as loadModelCatalog, gu as listChannelPlugins, i as resolveProfileUnusableUntilForDisplay, jl as loadSessionStore, jp as writeConfigFile, jt as resolveCronStorePath, ka as buildGatewayConnectionDetails, m as ensureAuthProfileStore, of as hasAmbiguousGatewayAuthModeConfig, ph as DEFAULT_PROVIDER, rp as DEFAULT_SANDBOX_BROWSER_IMAGE, sp as resolveBootstrapMaxChars, tr as buildBootstrapInjectionStats, u as repairOAuthProfileIdMismatch, v as updateAuthProfileStoreWithLock, w as getModelRefStatus, wm as resolveApiKeyForProvider, xu as formatSessionArchiveTimestamp, zd as resolveConfiguredSecretInputWithFallback, zt as buildAuthHealthSummary, zu as cleanStaleLockFiles } from "./auth-profiles-DZ4zIQH4.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-lHks6gb9.js";
import { T as parseAgentSessionKey } from "./session-key-9lbhEIb9.js";
import { _ as shortenHomePath, h as resolveUserPath, v as sleep } from "./utils-D0Yqqtk-.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-BMx4PoTI.js";
...
import { r as resolveMemoryBackendConfig } from "./search-manager-Cs4X-3T9.js";
import { c as inspectPortUsage, d as formatPortDiagnostics } from "./cmd-argv-DN-N1T_K.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CmL1n6G7.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CNBV5j35.js";
...
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-Cp3Ohrwt.js";
...
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DnPtziIn.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-4CUqO3j0.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-RMKmz23C.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-B3R7Bffy.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-BYHD2rMv.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-B9uQ0VXf.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-BJIjjTO2.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-BRnx3cm_.js";
import { n as readLastGatewayErrorLine } from "./diagnostics-hEPUS2XY.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-EtxNoo83.js";
import { r as healthCommand } from "./health-BIaLfF-x.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-lWSG1DR8.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-BPgheM9i.js";
import { f as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-BGditnUc.js";
import { t as resolveDmAllowState } from "./dm-policy-shared-DsAESt5G.js";
import { n as logConfigUpdated } from "./logging-D3TCKWkc.js";
import { t as note$1 } from "./note-QL6AfaP7.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-BtOhpKur.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CxMnvezH.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-F1RJTY3g.js";
import { t as formatHealthCheckFailure } from "./health-format-BPdO9h6y.js";
import { n as doctorShellCompletion } from "./doctor-completion-B6S6YHiO.js";
